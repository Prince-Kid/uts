...
const allProducts = [
  {
    ...
    image: "https://res.cloudinary.com/dvhfu2a0u/image/upload/v1733928432/xew64cujymb7bisbqk41.png",
    category: "Men",
    subcategory: "Shirts",
    color: "Blue",
    size: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    price: 129000,
    image: "https://res.cloudinary.com/dvhfu2a0u/image/upload/v1733928697/muenmhu1m9kg7s1likwe.png",
    category: "Women",
    subcategory: "Dresses",
    color: "Red",
    size: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    price: 159000,
    image: "https://res.cloudinary.com/dvhfu2a0u/image/upload/v1733928432/wt5aeydrj1uuubo0bpxe.png",
    category: "Men",
    subcategory: "Jackets",
    color: "Black",
    size: ["M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    price: 49000,
    originalPrice: 65000,
    image: "https://res.cloudinary.com/dvhfu2a0u/image/upload/v1733928432/pux3fp5a55u6jvkbw1jh.png",
  ...
  },
  {
    ...
    price: 79000,
    image: "https://res.cloudinary.com/dvhfu2a0u/image/upload/v1733927698/skvqoummhwjabe8guehp.png",
    category: "Men",
    subcategory: "Pants",
    color: "Green",
    size: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    image: "https://res.cloudinary.com/dvhfu2a0u/image/upload/v1733928432/udgsa5tjaie1op0huina.png",
    category: "Accessories",
    subcategory: "Bags",
    color: "Black",
    size: ["One Size"],
  ...
  },
  {
    ...
    price: 139000,
    image: "https://res.cloudinary.com/dvhfu2a0u/image/upload/v1733928431/rqa0tmbv1o1sh00apuq9.png",
    category: "Women",
    subcategory: "Kimonos",
    color: "Yellow",
    size: ["S", "M", "L"],
      ...
      <section className="py-12 bg-gray-50">
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { name: "Men", image: "https://res.cloudinary.com/dvhfu2a0u/image/upload/v1733928432/udgsa5tjaie1op0huina.png", link: "/categories/men", count: allProducts.filter(p => p.category === "Men").length },
              { name: "Women", image: "https://res.cloudinary.com/dvhfu2a0u/image/upload/v1733928697/muenmhu1m9kg7s1likwe.png", link: "/categories/women", count: allProducts.filter(p => p.category === "Women").length },
              { name: "Kids", image: "https://res.cloudinary.com/dvhfu2a0u/image/upload/v1733928432/pux3fp5a55u6jvkbw1jh.png", link: "/categories/kids", count: allProducts.filter(p => p.category === "Kids").length },
              { name: "Accessories", image: "https://res.cloudinary.com/dvhfu2a0u/image/upload/v1733928431/rqa0tmbv1o1sh00apuq9.png", link: "/categories/accessories", count: allProducts.filter(p => p.category === "Accessories").length },
            ].map((category) => (
              <button
                key={category.name}
                onClick={() => {

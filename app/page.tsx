...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
            ...
            <TabsContent value="bestsellers" className="mt-8">
              <div className="text-center py-12">
                <p className="text-gray-500">
                  Bestsellers section coming soon...
                </p>
              </div>
            </TabsContent>
      ...
      {/* About UTS Section */}
      <section className="py-16 bg-gradient-to-r from-[#3c5e9e] to-[#2a4a7a] text-white">
        <div className="container px-4 mx-auto">
            ...
            <div className="flex-1 relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-[#f4fc0a] text-[#3c5e9e] p-6 rounded-xl shadow-xl">
                ...
                <p className="text-sm font-medium">
                  By UMURAGE TWIZERIMANA Schadrack
                </p>
              </div>
            </div>
        ...
        <div className="container px-4 mx-auto">
            ...
            {[
              {
                ...
                quote:
                  "The quality of UTS clothing is exceptional. I love how they blend traditional patterns with modern styles. Every piece tells a story and makes me feel connected to my heritage.",
                image:
              ...
              },
              {
                ...
                location: "London, UK",
                quote:
                  "I discovered UTS during my visit to Rwanda and was immediately impressed. The attention to detail and the story behind each garment make them truly special. I always receive compliments when wearing my UTS shirt.",
                image:
              ...
              },
              {
                ...
                quote:
                  "As someone who values both style and cultural representation, UTS has been a revelation. Their educational content about how each piece is made adds so much value to the shopping experience.",
                image:
              ...
              >
                <CardContent className="pt-6 pb-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-[#3c5e9e]">
                        {testimonial.name}
                      </p>
          ...
          <div className="flex justify-center mt-12">
            <Button
              variant="outline"
              size="lg"
              className="border-[#3c5e9e] text-[#3c5e9e] hover:bg-[#3c5e9e] hover:text-white px-8 py-6 text-lg"
            >
      ...
      {/* Newsletter */}
      <section className="py-16 bg-gradient-to-r from-[#f4fc0a] to-[#e6f000]">
        <div className="container px-4 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-bold text-4xl md:text-5xl text-[#3c5e9e] mb-4">
              Join Our Community
            </h2>
            <p className="text-[#3c5e9e]/80 mb-8 text-lg">
              Subscribe to our newsletter for exclusive offers,
              behind-the-scenes content, and early access to new collections.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <Input
                type="email"
                placeholder="Your email address"
                className="flex-1 border-[#3c5e9e]/20 focus:border-[#3c5e9e] bg-white/90 backdrop-blur-sm"
              />
              <Button className="bg-[#3c5e9e] hover:bg-[#2a4a7a] text-white px-8 py-6 font-semibold">
                Subscribe
              </Button>
            </div>
          </div>
